...
/* GULP TASKS */
/* Additionally */
gulp.task("image:deploy", function(done) {
...
gulp.task("move-asset:deploy", function(done) {
...
gulp.task("script:deploy", function() {
  ...
  */
  return gulp
    .src([
      "./src/script/cource/**/*.js",
    ])
    // .pipe(babel()) //Почему-то крашит сборку при любой ошибке
    .pipe(webpack(require("./../webpack.config.js")))
    .pipe(gulp.dest("./build/js"))
})
gulp.task("asset:deploy", gulp.parallel("image:deploy", "move-asset:deploy"))
